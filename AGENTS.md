...
Tres juegos Angular 18 independientes (no es un monorepo):
...
- Trivia y Memotest envuelven la app Angular con Electron
...
- `sweetalert2` usado en los 3 juegos
...
- Los 3 proyectos usan Angular 18.2 + TypeScript ~5.5 + Zone.js ~0.14
